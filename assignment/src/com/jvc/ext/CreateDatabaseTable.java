...
/**
 * This Program was created to test the working of processData.java program. 
 * @author datduyn
 *
 */
public class CreateDatabaseTable {
	public static void createTable() {
		...
		InvoiceData.addPerson("ma12","Sveum","Dale","1060 West Addison Street","Chicago","IL","60613","USA");
		InvoiceData.addPerson("321nd","Hartnell","William", "1060 West Addison Street","Chicago","IL","60613","USA");
		InvoiceData.addPerson("nf32a","Troughton","Patrick","1060 West Addison Street","Chicago","IL","60613","USA");
		InvoiceData.addPerson("321na","Pertwee","Jon", "301 Front St W", "Toronto", "ON", "M5V 2T6", "Canada");
		InvoiceData.addPerson("231","Baker","Tom","1 Blue Jays Way", "Toronto", "ON", "M5V 1J1","Canada");
		InvoiceData.addPerson("6doc","Hurndall","Richard","Campos El290","Mexico City", "FD"," ", "Mexico");
		InvoiceData.addPerson("321dr","Baker","C.", "Avery Hall","Lincoln","NE","68503","USA");
		InvoiceData.addPerson("1svndr","McCoy","Sylvester", "126-01 Roosevelt Ave", "Flushing", "NY","11368","USA");
		InvoiceData.addPerson("1231st","McGann","Paul","1 MetLife Stadium Dr", "East Rutherford", "NJ","07073","USA");
		InvoiceData.addPerson("nwdoc1","Eccleston","Chris","1 E 161st St", "Bronx", "NY","10451","USA");
		InvoiceData.addPerson("2ndbestd","Tennant","David","700 E Grand Ave", "Chicago", "IL", "60611","USA");
		InvoiceData.addPerson("wrddoc","Smith","Matt","333 W 35th St", "Chicago", "IL","60616","USA");
		InvoiceData.addPerson("bbchar","Ehrmantraut","Kaylee", "800 West 7th Street", "Albuquerque", "NM", "87105","USA");
		InvoiceData.addPerson("doc05","Davison","Peter", "123 Cabo San Lucas", "Los Cabos", "BCS","11111", "Mexico");
